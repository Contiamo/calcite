...
public enum BuiltInMethod {
  ...
  POSIX_REGEX_CASE_SENSITIVE(SqlFunctions.class, "posixRegexCaseSensitive", String.class, String.class),
  POSIX_REGEX_CASE_INSENSITIVE(SqlFunctions.class, "posixRegexCaseInsensitive", String.class, String.class),
